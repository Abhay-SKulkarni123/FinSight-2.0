...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@finsight.app')
...
if not DEBUG:
    ...
    CORS_ALLOWED_ORIGINS = []  # Configure for your production domain
...
ML_MODELS_DIR = BASE_DIR / 'main' / 'ml_cache'
...
LOGGING = {
    ...
    'loggers': {
        ...
        'main': {'handlers': ['console'], 'level': 'DEBUG' if DEBUG else 'INFO', 'propagate': False},
    },
}